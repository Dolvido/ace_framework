...
def post_message():
    ...
    if not message or not isinstance(message, dict) or not message.get('message'):
        return 'Invalid message format', 400  # Return a 400 Bad Request error for invalid messages
